...
public class TeacherDAO extends BaseDAO {
    ...
    public List<TeacherEntity> getPageEntity(Integer index, String departmentName, String name) {
        Page<TeacherEntity> page = new Page<>(index, PAGE_SIZE);

        return mapper.getPageEntity(page, departmentName, name).getRecords();
    }

    public TeacherEntity getByNumber(String number) {
        return mapper.getByNumber(number);
    }
