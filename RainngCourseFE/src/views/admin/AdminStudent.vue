    ...
    <div class="container">
      <div class="query-form">
        <el-row :gutter="20">
          ...
          <el-col :span="3">
            <el-upload
              class="upload-demo"
              action="http://localhost:8085/admin/file/export/exportFile"
              :data="uploadData">
              <el-button size="small" type="primary">点击上传</el-button>
            </el-upload>
          </el-col>
          <el-col :offset="30" :span="3">
            <el-input @keyup.enter.native="query" placeholder="学生姓名" v-model="queryForm.name" />
          </el-col>
          <el-col :span="3">
            <el-input @keyup.enter.native="query" placeholder="毕业专业" v-model="queryForm.majorName" />
          </el-col>
          <el-col :span="3">
            <el-input @keyup.enter.native="query" placeholder="毕业学校" v-model="queryForm.className" />
          </el-col>
          <el-col :span="3">
      ...
      <div class="table">
        <el-table :data="tableData" stripe>
          ...
          <el-table-column label="毕业学校" prop="className" />
          <el-table-column label="毕业专业" min-width="150px" prop="majorName" />
          <el-table-column label="上次登录" prop="lastLoginTime" width="130px" />
          <el-table-column align="center" label="操作" width="200px">
            <template slot-scope="scope">
              <el-button @click="edit(scope.row.studentUuid)" size="mini" type="success">编辑</el-button>
              <el-button @click="deleteItem(scope.row.studentUuid)" size="mini" type="danger">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
